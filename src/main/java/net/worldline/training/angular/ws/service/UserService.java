...
import net.worldline.training.angular.data.user.RoleEnum;
import net.worldline.training.angular.data.user.Token;
import net.worldline.training.angular.entity.User;
import net.worldline.training.angular.services.UserDAO;
