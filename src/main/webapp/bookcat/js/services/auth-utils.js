...
app.factory('Register', ['$resource',
    function ($resource) {
        return $resource('api/app/account/register', {}, {
        });
    }]);

app.factory('Activate', ['$resource',
    function ($resource) {
        return $resource('api/app/rest/activate', {}, {
...
app.factory('Account', ['$resource',
    function ($resource) {
        return $resource('api/app/user/account', {}, {
        });
    }]);
...
app.factory('LogsService', ['$resource',
    function ($resource) {
        return $resource('api/app/rest/logs', {}, {
...
app.factory('AccessToken', ['$location', '$http', 'StorageService', '$rootScope',
...
app.factory('AuthenticationSharedService', ['$rootScope', '$http',  'Session', 'Account','AccessToken',
    function ($rootScope, $http,  Session, Account,AccessToken) {
        return {
            login: function (param) {
                var data ="j_username=" + param.username +"&j_password=" + param.password +"&_spring_security_remember_me=" + param.rememberMe +"&submit=Login";
                return $http.post('api/app/user/authentication', data, {
                   headers: {
            ...
            valid: function (authorizedRoles) {
                ...
                $http.get('api/app/user/validate', {
                    ignoreAuthModule: 'ignoreAuthModule'
                }).success(function (data, status, headers, config) {
